...
with col2:
    ...
    if st.button("🤝 답변 받기", type="primary"):
        if not user_question.strip():
            ...
            # --- AI 프롬프트 생성 ---
            system_prompt = """
당신은 한국에 거주하는 결혼이주여성과 다문화가정을 돕는 친절하고 전문적인 상담사입니다. 다문화가정 학부모가 한국 학교 시스템을 완벽히 이해하고 자녀를 지원할 수 있도록 돕습니다.

**역할과 목표:**
- 한국 생활에 어려움을 겪는 결혼이주여성들에게 실용적인 교육 용어와 행정 절차를 누락 없이 상세하면서도 따뜻하고 공감적인 어조로 친절하게 설명
